...
0   Bewegung           Schalten aufgrund Bewegung   EIS 1 1 Bit           K     �
1   Sperre             Sperre des Bewegungsmelders  EIS 1 1 Bit           K   S
2   Master Trig        Eingang / Ausgang            EIS 1 1 Bit           K L S �
3   Helligk. Schw.     abrufen = 01dez (01hex)      DPT. 18.001 1 Byte    K   S
                       speichern = 129dez (81hex)
4   Helligk. Schwelle  Sollwert                     EIS 5 2 Byte          K L S �
5   Konstantlicht Reg. Dimmer                       EIS 2 4 Bits 1 Byte   K L   �
6   Sperr K.licht Reg. Sperre der Konstantlicht R.  EIS 1 1 Bit           K   S
7   Helligk. Lichreg.  Sollwert                     EIS 5 2 Byte          K L S �
8   Helligk. abrf.sp.  abrufen = 01dez (01hex)      DPT. 18.001 1 Byte    K   S
                       speichern = 129dez (81hex)
9   Helligkeitswert    Helligkeitswert              EIS 5 2 Byte          K     �
10  Inbetriebnahme     Eingang                      EIS 1 1 Bit           K   S

# nur Sphinx 332
11  Bewegung 2         Schalten aufgrund Bewegung 2 EIS 1 1 Bit           K     �
12  Sperre 2           Sperre des Bewegungsms 2     EIS 1 1 Bit           K   S
13  Helligk. Schw.     abrufen = 01dez (01hex)      DPT. 18.001 1 Byte    K   S
                       speichern = 129dez (81hex)
14  Helligk. Schwelle  Sollwert                     EIS 5 2 Byte          K L D �

Flag  Name              Bedeutung
K     Kommunikation     Objekt ist kommunikationsf�hig
